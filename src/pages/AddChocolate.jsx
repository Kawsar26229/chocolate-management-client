...
const AddChocolate = () => {
  ...
  const handleSave = (event) => {
    ...
    const chocolate = { photoURL, name, country, category };
  ...
  return (
    <div className="mt-6">
      <Link to="/" className="btn btn-outline btn-ghost my-6">
        <FaArrowLeft /> All Chocolate{" "}
        <svg
      ...
      <div className="bg-zinc-100 p-12">
        <h2 className="text-lg font-bold text-center">New Chocolates</h2>
        ...
        <form onSubmit={handleSave} className="card-body">
          ...
          <div className="form-control">
            ...
            >
              <option disabled>Pick Your Favorite Chocolate Category</option>
          ...
          <div className="form-control mt-6">
            <button className="btn bg-orange-950 text-white">Save</button>
          </div>
        </form>
      </div>
    </div>
